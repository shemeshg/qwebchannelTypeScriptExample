export module MidiOutConstants{
...
export class WcMidiOut{
    ...
    getPorts():Promise<{ key: number; value: string; }[]>{
        return new Promise((resolve)=>{
            this.wcmidioutWs.getPorts( (arg:any)=>{
                resolve(arg);
            })
        })     
    }
    ...
    getOpenedPorts():Promise<{ key: number; value: string; }[]>{
        return new Promise((resolve)=>{
            this.wcmidioutWs.getOpenedPorts( (arg:any)=>{
    ...
    openVirtualPort( portName:string){
        return new Promise((resolve)=>{
            this.wcmidioutWs.openVirtualPort( portName, (arg:any)=>{
                resolve();
            })
        })           
    }
    ...
    async port(n:number){
        if (this._isPortCashed(n)){
                return new _MidiOutPort(this.wcmidioutWs, n);
        }
